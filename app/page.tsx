          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "WSE",
                description: "نظام إدارة وخدمات متطور",
                fullDescription: "WSE هو نظام إدارة شامل ومتطور يوفر حلول تقنية متكاملة للشركات والمؤسسات. يتميز النظام بواجهة إدارية سهلة ومرونة في التخصيص حسب احتياجات العميل.",
                features: [
